...
KEGIATAN_BOK = {
    ...
    # 26. KAMRT - allow_double_luar True, allow_double_dalam True, allow_penyerta_jadi_petugas True
    'Surveilans Kualitas Air Minum Rumah Tangga (KAMRT)': {
        ...
        'allow_double_dalam': True,
        'allow_double_luar': True,
        'allow_penyerta_jadi_petugas': True,  # Flag untuk izinkan penyerta menjadi petugas
    },
